...
public class WebCrawlerForJobLinksTest2 {
    ...
    public static void main(String[] args) {
        WebCrawlerForJobLinksTest2 crawler = new WebCrawlerForJobLinksTest2();
        crawler.urls.add(args[0]);
        System.out.println("------------------------------------------------------------");
    ...
    public void initiate() {
        ...
        for (String url : urls) {
            ...
            System.out.println("------------------------------------------------------------");
            System.out.println("Here begins the html document:");
            System.out.println(document.toString());
            if (document == null) {
                write(url + "\n", "careerLinks/sdeJobLinksTest/processedJobLinks.txt");
                processedUrls.add(url);
                write(jobLink.asString(), "careerLinks/sdeJobLinksTest/processedJobLinksLog.txt");
                continue;
            }
            ...
            if (jobLink.matchedTechFramesCount <= keywordCountThreshold) {
                System.out.println("------------------------------------------------------------");
                System.out.println("This page has only " + jobLink.matchedTechFramesCount + " matched component and is not a SDE job posting page.");
                write(url + "\n", "careerLinks/sdeJobLinksTest/processedJobLinks.txt");
                processedUrls.add(url);
                write(jobLink.asString(), "careerLinks/sdeJobLinksTest/processedJobLinksLog.txt");
                continue;
            ...
            if (content.length() > 14000) {
                ...
                write(url + "\n", "careerLinks/sdeJobLinksTest/tooLongJobLinks.txt");
                processedUrls.add(url);
                write(url + "\n", "careerLinks/sdeJobLinksTest/processedJobLinks.txt");
                continue;
            }
...
//                        System.out.println(processContent);
            ...
            System.out.println("------------------------------------------------------------");
            System.out.println("This is JSON processed content: ");
            System.out.println(processContent);
            System.out.println("------------------------------------------------------------");
            System.out.println("Sending Questions to GPT: ");
            ...
            write(url + "\n", "careerLinks/sdeJobLinksTest/gptProcessedJobLinks.txt");
            gptProcessedUrls.add(url);
            if (processAnswers[0].equals("No")) {
                write(url + "\n", "careerLinks/sdeJobLinksTest/processedJobLinks.txt");
                processedUrls.add(url);
                write(jobLink.asString(), "careerLinks/sdeJobLinksTest/processedJobLinksLog.txt");
                write(jobLink.asString(), "careerLinks/sdeJobLinksTest/gptProcessedJobLinksLog.txt");
                continue;
            }
            ...
            if (num == 0 && !jobLink.jobTitle.contains("Senior") && !jobLink.jobTitle.contains("Staff")) {
                write(jobLink.jobTitle + "\n" + url + "\n", "careerLinks/sdeJobLinksTest/newgrad.txt");
            } else {
                write(jobLink.jobTitle + "     experiece of at least" + num + " years" + "\n" + url + "\n", "careerLinks/sdeJobLinksTest/experienced.txt");
            }
        }
        ...
        for (JobLink jobLink : LJL) {
            write(jobLink.matchedTechFramesCount + " " + jobLink.url, "careerLinks/sdeJobLinksTest/processedJobLinksLogTest.txt");
        }
    }
