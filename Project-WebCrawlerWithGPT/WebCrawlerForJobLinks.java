...
public class WebCrawlerForJobLinks {
    ...
    HashSet<String> processedUrls = new HashSet<>(readFileToList("careerLinks/sdeJobLinks/processedJobLinks.txt", "\n"));
    HashSet<String> gptProcessedUrls = new HashSet<>(readFileToList("careerLinks/sdeJobLinks/gptProcessedJobLinks.txt", "\n"));
